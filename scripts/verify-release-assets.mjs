...
const PACKAGED_RESOURCE_PATHS = Object.freeze([
  ...
  'contracts/README.md',
  'contracts/archon-2026-07-v6.corpus.json',
  'contracts/archon-2026-07-v6.json',
  'contracts/hermes-legacy-v2.corpus.json',
  ...
  'examples/packages/command-resources/commands/summarize.md',
  'examples/packages/command-resources/digests.json',
  'examples/packages/command-resources/workflow-package.json',
  'examples/packages/command-resources/workflows/command-demo.hermes.yaml',
  'examples/packages/command-resources/workflows/command-demo.yaml',
  'examples/packages/external-requirements/digests.json',
  'examples/packages/external-requirements/workflow-package.json',
  'examples/packages/external-requirements/workflows/external-tool.hermes.yaml',
  'examples/packages/external-requirements/workflows/external-tool.yaml',
  'examples/packages/laptop-diagnostic/commands/interpret-report.md',
  'examples/packages/laptop-diagnostic/digests.json',
  'examples/packages/laptop-diagnostic/fixtures/laptop-snapshot.json',
  'examples/packages/laptop-diagnostic/scripts/analyze-snapshot.py',
  'examples/packages/laptop-diagnostic/scripts/render-report.py',
  'examples/packages/laptop-diagnostic/workflow-package.json',
  'examples/packages/laptop-diagnostic/workflows/laptop-diagnostic.hermes.yaml',
  'examples/packages/laptop-diagnostic/workflows/laptop-diagnostic.yaml',
  'examples/packages/multi-workflow-support/digests.json',
  'examples/packages/multi-workflow-support/scripts/shared-support.py',
  'examples/packages/multi-workflow-support/workflow-package.json',
  'examples/packages/multi-workflow-support/workflows/collect-bundle.hermes.yaml',
  'examples/packages/multi-workflow-support/workflows/collect-bundle.yaml',
  'examples/packages/multi-workflow-support/workflows/diagnose.hermes.yaml',
  'examples/packages/multi-workflow-support/workflows/diagnose.yaml',
