...
The v3.0.3 UI branding release replaces user-facing Hermes branding with loop24 or neutral wording while preserving technical identifiers, filenames and workflow YAML. See the [v3.0.3 acceptance record](verification/version-3.0.3-release-acceptance.md) for build and publication status. The verified installer commands below always select the latest published release.
