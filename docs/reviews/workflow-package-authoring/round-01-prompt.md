...
- Round: `01`
- Round emphasis: `Contract fidelity and package compatibility: exact-byte provenance, all vector families/recipes, semantic validation beyond JSON Schema, Unicode ordering/case folding, manifest/index agreement, resolver/profile coverage and honest unsupported behavior.`
...
- Candidate commit: `8244e8aeda39d7b759a106ca85f5fb5d1cd63193`
...
- Review range: `b79d4b1646cb93b47ddab2bf695fc614caf5814e..8244e8aeda39d7b759a106ca85f5fb5d1cd63193`
- Changed-path inventory and document/artifact checksums: `inventory and SHA-256 table below`
- Required report: `docs/reviews/workflow-package-authoring/round-01-review.md`
...
- The controller currently owns a quiet Windows functional browser gate. Begin with source/contract review; request a test window before any test runner, build, browser, or CPU-heavy probe so the gate remains isolated. Read-only bounded file and Git inspections are available immediately.
...
| `docs/reviews/2026-09-22-workflow-package-authoring-adversarial-review-prompt.md` | `793c367bad47ae6437f852540883b9b42aed9cb50046ea95e59f29c2274021d3` |
