...
| Full verification | Format, lint, Svelte/TypeScript, 894 unit/component/integration tests, 234 Rust unit tests, and 24 real Git integration tests. Contracts, examples, production renderer, and CI workflow syntax also pass. | Passed locally on macOS arm64 |
