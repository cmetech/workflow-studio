...
Inspector caller behavior and listener cleanup. Immutable confirmation and
the corrected full frontend/browser gates remain pending.
...
corrected run must still pass with unchanged assertions and timeouts.
