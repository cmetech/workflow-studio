...
3. Complete the v1.0.8 local verification record and prepare the macOS/Windows clean-machine acceptance record for post-publication follow-up.
4. Create an annotated `v1.0.8` tag on a commit contained in `origin/base`, then push that exact tag.
