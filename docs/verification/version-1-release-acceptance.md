...
| Full verification | Format, lint, Svelte/TypeScript, 1,030 TypeScript unit/component/integration tests, 236 Rust unit tests, 24 real Git integration tests, and 9 Playwright E2E scenarios. Contracts, examples, production renderer, and CI workflow syntax also pass. | Passed locally on macOS arm64 |
...
1. Create the immutable `v1.0.3` tag and draft release from the approved commit, without publishing it.
