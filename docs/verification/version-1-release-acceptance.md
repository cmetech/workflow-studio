...
| Full verification | Format, lint, Svelte/TypeScript, 1,010 TypeScript unit/component/integration tests, 236 Rust unit tests, 24 real Git integration tests, and 9 Playwright E2E scenarios. Contracts, examples, production renderer, and CI workflow syntax also pass. | Passed locally on macOS arm64 |
