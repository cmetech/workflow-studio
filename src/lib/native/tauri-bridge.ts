...
import {
  ...
  type BrandActiveLoadResult,
  type BrandActivationResult,
  type BrandPackListResult,
  type BrandRemovalResult,
...
export const tauriBridge: WorkspaceNativeBridge = {
  ...
  brandActivate: (id) => invokeTyped<BrandActivationResult>('activate_brand_pack', { id }),
  brandRemove: (id, revertActive) => invokeTyped<BrandRemovalResult>('remove_brand_pack', { id, revertActive }),
  brandLoadActive: () => invokeTyped<BrandActiveLoadResult>('brand_load_active'),
  brandListPacks: () => invokeTyped<BrandPackListResult>('brand_list_packs'),
  brandLoadPack: (id) => invokeTyped<StoredBrandPack>('brand_load_pack', { id }),
  setWindowIcon: (id, expectedRevision) => invokeTyped('set_window_icon', { id, expectedRevision }),
