...
| Full verification | Format, lint, Svelte/TypeScript, 1,142 TypeScript unit/component/integration tests, 245 Rust unit tests, 24 real Git integration tests, and 276 Playwright E2E tests. Contracts, examples, bundled resources, production renderer, and release metadata also pass. | Passed locally on macOS arm64 |
...
1. Create the immutable `v1.0.4` tag and draft release from the approved commit, without publishing it.
