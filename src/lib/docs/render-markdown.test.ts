...
describe('renderMarkdown', () => {
  it('removes active markup and unsafe URLs while preserving the guide elements and internal topic links', () => {
...
[internal](#field:prompt.node.prompt) [unsafe](javascript:alert(1)) [external](https://docs.example.test)
`)
    ...
    expect(html).toContain('href="#field:prompt.node.prompt"')
