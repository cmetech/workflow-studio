...
- Round: `03`
- Round emphasis: `Authoring correctness and recovery: inline/named scripts, runtime-specific lookup, YAML preservation, reference rewrites, multi-package state isolation, concurrent edits, invalid drafts, external changes, binary handling, and no accidental execution.`
...
- Candidate commit: `bda0d2ca00b60d5228b2b0b023389f5668c3b44f`
- Candidate tree: `02ee6335d1f21e27982922212f6d9657ba68c221`
- Read-only agent reference commit: `3e89c2659b6e9c95a627b8f819ff63a11529d86a`
- Review range: `b79d4b1646cb93b47ddab2bf695fc614caf5814e..bda0d2ca00b60d5228b2b0b023389f5668c3b44f`
- Changed-path inventory and document/artifact checksums: `inventory and SHA-256 table below`
- Required report: `docs/reviews/workflow-package-authoring/round-03-review.md`
